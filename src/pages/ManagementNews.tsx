      ...
      <main className="flex-1 p-8 overflow-y-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button className="px-4 py-2 rounded-lg bg-green-600 text-white hover:bg-green-700 flex items-center gap-2">
            <FilePlus className="w-4 h-4" /> Tambah Berita
          </button>
        </div>
        ...
        <section className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white border rounded-xl p-5 flex items-center gap-4">
            ...
            <div>
              ...
              <h3 className="text-xl font-semibold">36</h3>
            </div>
          </div>
        ...
        <section className="bg-white border rounded-xl p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="font-semibold text-gray-800">Daftar Berita</h2>
            <input
              type="text"
            ...
            <tbody className="divide-y">
              <tr>
                <td className="px-4 py-3 font-medium">
                  Peningkatan Akses Jalan di Wilayah Barat
                </td>
                <td className="px-4 py-3">Infrastruktur</td>
                <td className="px-4 py-3">11 Okt 2025</td>
                <td className="px-4 py-3 text-green-600 font-medium">Terbit</td>
              ...
              <tr>
                <td className="px-4 py-3 font-medium">
                  Sosialisasi Rencana Tata Ruang di Kedung Waringin
                </td>
                <td className="px-4 py-3">Sosialisasi</td>
                <td className="px-4 py-3">10 Okt 2025</td>
                <td className="px-4 py-3 text-yellow-600 font-medium">Draft</td>
                <td className="px-4 py-3 text-center">
                  <div className="flex justify-center gap-3">
                    <button className="text-blue-600 hover:text-blue-800">
                      <Edit3 className="w-4 h-4" />
